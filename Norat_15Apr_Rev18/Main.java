		...
		for (int i  = 0; i < routesInfo.size(); i++) {
			...
			for (int j = 0; j < closuresInfo.size(); j++) {
				...
				if (routesInfo.get(i)[2].equals(closuresInfo.get(j)[0]) ) {
					...
					if (Integer.parseInt(routesInfo.get(i)[3]) <= Integer.parseInt(closuresInfo.get(j)[2].substring(0,3)) && 
					...
					if (Integer.parseInt(routesInfo.get(i)[5]) <= Integer.parseInt(closuresInfo.get(j)[2].substring(0,3)) &&
