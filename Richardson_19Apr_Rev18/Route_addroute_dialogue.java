...
public class Route_addroute_dialogue extends JDialog {
	...
	class addRouteListener implements ActionListener{
		public void actionPerformed(ActionEvent event) {
			...
			depHourString = TimeSelectBoxPanel.Hourlist[depHourInt];
			depMinString = TimeSelectBoxPanel.Minutelist[depMinInt];
			...
			arrHourString = TimeSelectBoxPanel.Hourlist[arrHourInt];
			arrMinString = TimeSelectBoxPanel.Minutelist[arrMinInt];
			...
			try {
				Double.parseDouble(priceCentsString);
			} catch (Exception e) {
				priceError = true;
			}
