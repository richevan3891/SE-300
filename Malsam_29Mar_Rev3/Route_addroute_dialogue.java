...
public class Route_addroute_dialogue extends JDialog {
	...
	// Allow for only three values to be entered into the text box
	...
	public Route_addroute_dialogue(String[] Airports) {
		...
		// Only allow for numbers to be added in the text field
		
		Routenumtxt.addKeyListener(new KeyAdapter() {
