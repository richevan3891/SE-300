...
public class Main implements ActionListener{
	...
	public JPanel Panels() throws IOException {
		...
		try {
			...
			String[] airportsArray = convertAirportArrayListToArray(airportsInfo);
			String[][] closuresArray = convertArrayListTo2DArray(closuresInfo, 0);
		...
		routeTable = new JTable(data, columnNames);
		...
		routePanel.add(routeTableScroll); //add the table to the JPanel
	...
	// this method is used to determine the list of routes from the text file
	public String[] routesArrayList() {
		ArrayList routesList;
		...
		routesList = data.routeArrayList(data.routesToken);
		routesArray = convertRoutesArrayListToArray(routesList);
		return routesArray;
	}
	...
	String[] convertAirportArrayListToArray(ArrayList airportArrayList) {
