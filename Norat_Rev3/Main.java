...
public class Main implements ActionListener{
	...
	public JPanel Panels() throws IOException {
		...
		//Create the initial Routes Table
				...
				ArrayList routesInfo = input.routeArrayList(input.routesToken); //get routes info from the input file
				...
				//Check for any errors in routesInfo  (in FileInput class, if there is an error routesToken will be set to null)
				Object[][] data;
				try {
					...
					data = new Object[0][7];
					//NEED TO ADD NOTIFICATION FOR USER THAT INPUT.TXT WAS FAULTY
					System.out.println("There are errors in the #routes section of the input.txt file.");
				}
