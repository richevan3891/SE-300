...
public class Main implements ActionListener{
	...
	public JPanel Panels() throws IOException {
		...
		try {
			...
			String[] airportsArray = input.convertAirportArrayListToArray(airportsInfo);
	...
	public String[] airportsArrayList () {
		...
		airportsArray = data.convertAirportArrayListToArray(airports);
	...
	public String[] routesArrayList() {
		...
		routesArray = data.convertRoutesArrayListToArray(routesList);
		return routesArray;
	}
}